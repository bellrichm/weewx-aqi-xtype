...
class TestNowcastCalculate(unittest.TestCase):
    ...
    def test_calculate_series_prototype(self):
        ...
        self.assertEqual(start_vec,
                         [1740114000, 1740117600, 1740121200, 1740124800, 1740128400,
                          ...
                          1740175200, 1740178800, 1740182400, 1740186000, 1740189600, 1740193200])
        self.assertEqual(stop_vec,
                         [1740117600, 1740121200, 1740124800, 1740128400, 1740132000,
