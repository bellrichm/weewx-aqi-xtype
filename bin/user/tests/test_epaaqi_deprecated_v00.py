...
class EPAAQITests(unittest.TestCase):
    def test_pm2_5_calculation(self):
        ...
        self.assertEqual(calculator.calculate('pm2_5', (5.0)), 21)
        self.assertEqual(calculator.calculate('pm2_5', (23.0)), 74)
        self.assertEqual(calculator.calculate('pm2_5', (40.0)), 112)
        self.assertEqual(calculator.calculate('pm2_5', (100.0)), 174)
        self.assertEqual(calculator.calculate('pm2_5', (200.0)), 250)
        self.assertEqual(calculator.calculate('pm2_5', (300.0)), 350)
        self.assertEqual(calculator.calculate('pm2_5', (400.0)), 434)
        self.assertEqual(calculator.calculate('pm2_5', (600.0)), 566)
    ...
    def test_pm10_calculation(self):
        ...
        self.assertEqual(calculator.calculate('pm10', (475.0)), 364)
        self.assertEqual(calculator.calculate('pm10', (550.0)), 446)
        self.assertEqual(calculator.calculate('pm10', (700.0)), 596)
