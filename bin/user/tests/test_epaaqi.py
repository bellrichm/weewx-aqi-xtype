...
class EPAAQITests(unittest.TestCase):
    def test_pm2_5_calculation(self):
        ...
        self.assertEqual(calculator.calculate(None, 'pm2_5', (5.0)), 28)
        self.assertEqual(calculator.calculate(None, 'pm2_5', (23.0)), 77)
        self.assertEqual(calculator.calculate(None, 'pm2_5', (40.0)), 112)
        self.assertEqual(calculator.calculate(None, 'pm2_5', (100.0)), 182)
        self.assertEqual(calculator.calculate(None, 'pm2_5', (200.0)), 275)
        self.assertEqual(calculator.calculate(None, 'pm2_5', (300.0)), 449)
        self.assertEqual(calculator.calculate(None, 'pm2_5', (400.0)), 649)
        self.assertEqual(calculator.calculate(None, 'pm2_5', (600.0)), 1047)
    ...
    def test_pm10_calculation(self):
        ...
        self.assertEqual(calculator.calculate(None, 'pm10', (475.0)), 357)
        self.assertEqual(calculator.calculate(None, 'pm10', (550.0)), 440)
        self.assertEqual(calculator.calculate(None, 'pm10', (700.0)), 607)
